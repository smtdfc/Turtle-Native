import { TurtleComponent, createComponent } from '@smtdfcteam/turtle';

export class TurtleNativeRouteComponent extends TurtleComponent {
  constructor(props) {
    super(props)
    this.matched = false
  }
...
export const TurtleNativeRoute = createComponent(TurtleNativeRouteComponent)